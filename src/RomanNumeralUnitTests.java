...
//		assertEquals("MCC", number.toRoman(1200));
//		assertEquals("CMXCIX", number.toRoman(999));
//		assertEquals("MCCXXXIV", number.toRoman(1234));
//		//System.out.println(number.toRoman(48));
//		assertEquals("CCLX", number.toRoman(260));
//		assertEquals("CDLXXXV", number.toRoman(485));
